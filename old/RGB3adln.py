        ...
        if colorBtn[i]['color'][0]!=255 or colorBtn[i]['color'][1]!=255 or colorBtn[i]['color'][2]!=255:
            ...
            for ii in range(imgo.shape[0]):
                ...
                for iii in range(imgo.shape[1]):
                        if imgo[ii][iii][0] == i and flag==0:
                            pyautogui.mouseDown(mp[0]+iii*interval,mp[1]+ii*interval, button='left',duration=0)
                            flag=1
                        if flag==1 and iii+1==width:
                            pyautogui.moveTo(mp[0]+iii*interval,mp[1]+ii*interval)
                            pyautogui.mouseUp(mp[0]+iii*interval,mp[1]+ii*interval, button='left',duration=0)
                            flag=0
        ...
        for ii in range(imgo.shape[0]):
            ...
            for iii in range(imgo.shape[1]):
                        ...
                        if flag==1 and iii+1==width:
                            ...
                            pyautogui.mouseUp(mp[0]+iii*interval,mp[1]+ii*interval, button='left',duration=0)
                            flag=0
                        if flag==1 and imgo[ii][iii+1][1]!=i:
                            pyautogui.moveTo(mp[0]+iii*interval,mp[1]+ii*interval)
                            pyautogui.mouseUp(mp[0]+iii*interval,mp[1]+ii*interval, button='left',duration=0)
                            flag=0
        ...
        for ii in range(imgo.shape[0]):
            ...
            for iii in range(imgo.shape[1]):
                        ...
                        if flag==1 and iii+1==width:
                            ...
                            pyautogui.mouseUp(mp[0]+iii*interval,mp[1]+ii*interval, button='left',duration=0)
                            flag=0
                        if flag==1 and imgo[ii][iii+1][2]!=i:
                            pyautogui.moveTo(mp[0]+iii*interval,mp[1]+ii*interval)
                            pyautogui.mouseUp(mp[0]+iii*interval,mp[1]+ii*interval, button='left',duration=0)
                            flag=0
